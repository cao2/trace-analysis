...
public:
    ...
    virtual void read_cond(message_t&) = 0;
    virtual void read_cond(message_t&, command_t, address_t addr, uint16_t) = 0;
    virtual void read_cond_select(message_t&, command_t, command_t, uint16_t) = 0;
